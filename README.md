...
<a href="https://github.com/clouddrove/terraform-aws-pritunl/releases/latest">
  <img src="https://img.shields.io/github/release/clouddrove/terraform-aws-pritunl.svg" alt="Latest Release">
</a>
...
**IMPORTANT:** Since the master branch used in source varies based on new modifications, we recommend using the [release versions](https://github.com/clouddrove/terraform-aws-pritunl/releases).
...
This module has dependencies on:
- [Labels Module](https://github.com/clouddrove/terraform-aws-ec2): Provides resource tagging.
...
<a href="https://github.com/clouddrove/terraform-aws-pritunl/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=clouddrove/terraform-aws-pritunl&max" />
</a>
<br>
<br>
...
## Feedback 
Spot a bug or have thoughts to share with us? Let's squash it together! Log it in our [issue tracker](https://github.com/clouddrove/terraform-aws-pritunl/issues), feel free to drop us an email at [hello@clouddrove.com](mailto:hello@clouddrove.com).

Show some love with a ★ on [our GitHub](https://github.com/clouddrove/terraform-aws-pritunl)!  if our work has brightened your day! – your feedback fuels our journey!
